...
-- Create questions table with correct column names
...
INSERT INTO answers (question_id, user_id, content) VALUES
  ...
  ('11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000003', 'Here''s a step-by-step solution with detailed explanation...'),
  ...
  ('22222222-2222-2222-2222-222222222222', '00000000-0000-0000-0000-000000000003', 'Think of it as a plant''s way of making food using sunlight as energy...'),
  ('22222222-2222-2222-2222-222222222222', '00000000-0000-0000-0000-000000000004', 'The simple equation is: CO2 + H2O + sunlight = glucose + oxygen...'),
  ...
  ('44444444-4444-4444-4444-444444444444', '00000000-0000-0000-0000-000000000003', 'Begin with a bold statement or controversial opinion to grab attention...')
